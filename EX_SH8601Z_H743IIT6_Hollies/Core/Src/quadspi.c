...
void HAL_QSPI_MspDeInit(QSPI_HandleTypeDef* qspiHandle)
{
  ...
  /* USER CODE END QUADSPI_MspDeInit 0 */
    ...
    PC11     ------> QUADSPI_BK2_NCS
    */
    HAL_GPIO_DeInit(AMOLED_CLK_GPIO_Port, AMOLED_CLK_Pin);

    HAL_GPIO_DeInit(GPIOH, AMOLED_IO0_Pin|AMOLED_IO1_Pin);

    HAL_GPIO_DeInit(GPIOE, AMOLED_IO2_Pin|AMOLED_IO3_Pin);

    HAL_GPIO_DeInit(AMOLED_CS_GPIO_Port, AMOLED_CS_Pin);
